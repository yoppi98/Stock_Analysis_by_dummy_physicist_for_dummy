...
Close = intel_df["Close"][dt.datetime(2025, 12, 1):]
intel_df = intel_df["2025-12-01":]
...
addp = [
    mpf.make_addplot(intel_df["ma5"], color="yellow",width =1),
    mpf.make_addplot(intel_df["ma25"], color="blue",width =1),
